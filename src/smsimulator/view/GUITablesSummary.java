...
public class GUITablesSummary implements Component {
	...
	public JTable createTableInvestorsMaxCompanies(ArrayList<Transaction> transactions, ArrayList<Company> companies,
			ArrayList<Investor> investors) {

		SimulationResultsSummary summary = new SimulationResultsSummary();
		ArrayList<Integer> numberOfCompaniesByInvestor = summary.getNumberOfCompaniesByInvestor(transactions,
				investors);
	...
	public JTable createTableInvestorsMinCompanies(ArrayList<Transaction> transactions, ArrayList<Company> companies,
			ArrayList<Investor> investors) {
