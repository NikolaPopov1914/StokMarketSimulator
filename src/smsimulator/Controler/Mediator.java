...
public class Mediator implements MediatorInterface {
	...
	public void createGUI() {
		...
		panelSummary.setBorder(BorderFactory.createTitledBorder(null, "Summary of the Simulation", 0, 0,
				new Font("PLAIN", Font.BOLD, 12)));
		...
		panelCompaniesMaxcapital.setBorder(BorderFactory.createTitledBorder(null, "Companies with the highest capital",
				0, 0, new Font("PLAIN", Font.BOLD, 11)));
		JScrollPane scrollPaneCompMaxCapital = new JScrollPane(
				tableSummary.createTableCompaniesMaxCapital(transactions, companies));
		scrollPaneCompMaxCapital.setPreferredSize(new Dimension(345, 40));
		...
		panelCompaniesMincapital.setBorder(BorderFactory.createTitledBorder(null, "Companies with the lowest capital",
				0, 0, new Font("PLAIN", Font.BOLD, 11)));
		JScrollPane scrollPaneCompMinCapital = new JScrollPane(
				tableSummary.createTableCompaniesMinCapital(transactions, companies));
		scrollPaneCompMinCapital.setPreferredSize(new Dimension(345, 40));
		...
		panelInvestorsMaxShares.setBorder(BorderFactory.createTitledBorder(null,
				"Investor with the highest # of shares", 0, 0, new Font("PLAIN", Font.BOLD, 11)));
		JScrollPane scrollPaneInveMaxShares = new JScrollPane(
				tableSummary.createTableInvestorsMaxShares(transactions, investors));
		scrollPaneInveMaxShares.setPreferredSize(new Dimension(390, 75));
		panelInvestorsMaxShares.add(scrollPaneInveMaxShares);
		panelS.add(panelInvestorsMaxShares);

		// 2.4
		panelInvestorsMinShares = new JPanel();
		panelInvestorsMinShares.setBorder(BorderFactory.createTitledBorder(null, "Investor with the lowest # of shares",
				0, 0, new Font("PLAIN", Font.BOLD, 11)));
		JScrollPane scrollPaneInveMinShares = new JScrollPane(
				tableSummary.createTableInvestorsMinShares(transactions, investors));
		scrollPaneInveMinShares.setPreferredSize(new Dimension(390, 75));
		...
		panelInvestorsMaxCompanies.setBorder(BorderFactory.createTitledBorder(null,
				"Investors that invested in most COs", 0, 0, new Font("PLAIN", Font.BOLD, 11)));
		JScrollPane scrollPaneInveMaxComp = new JScrollPane(
				tableSummary.createTableInvestorsMaxCompanies(transactions, companies, investors));
		scrollPaneInveMaxComp.setPreferredSize(new Dimension(390, 75));
		...
		panelInvestorsMinCompanies.setBorder(BorderFactory.createTitledBorder(null,
				"Investors that invested in less COs", 0, 0, new Font("PLAIN", Font.BOLD, 11)));
		JScrollPane scrollPaneInveMinComp = new JScrollPane(
				tableSummary.createTableInvestorsMinCompanies(transactions, companies, investors));
		scrollPaneInveMinComp.setPreferredSize(new Dimension(390, 75));
	...
	public void userTurn() {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				...
				Investor i = new Investor(scanner.nextLine(), scanner.nextDouble());
				scanner.close();
			}
		});
	}
